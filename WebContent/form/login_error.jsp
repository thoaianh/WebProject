...
<body>
	...
	<!--Sign in-->
	<ul>
		<li><span><fmt:message key="defaultLanguage" />: </span><a
			href="?sessionLocale=en"><fmt:message key="lang.en" /></a></li>
		<li><span><fmt:message key="other" />: </span><a
			href="?sessionLocale=vi"><fmt:message key="lang.vi" /></a></li>
		<li><span><fmt:message key="other" />: </span><a
			href="?sessionLocale=fr"><fmt:message key="lang.fr" /></a></li>
	...
	<h4 style="text-align: center">
		<i style="color: red"><fmt:message key="loginErrorMessage" /> </i>
	</h4>
