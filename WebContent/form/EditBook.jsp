	...
	<div class="containner-fluit" style="margin:100px 100px">
		<form method="POST" action="EditServlet">
			...
			<div class="row">
				...
				<div class="col-md-5">
					<input type="text" name="title" size="20" value="${current.title}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-5">
					<input type="text" name="author" size="20" value="${current.author}">
				</div>
			</div>
			<div class="row">
				<div class="col-md-2">
				...
				<div class="col-md-5">
					<input type="text" name="price" size="20" value="${current.price}">
				</div>
			</div>
			<div class="row">
				<div class="col-md-2">
				...
				<div class="col-md-5">
					<input type="text" name="decription" size="20" value="${current.decription}">
				</div>
			</div>
			<div class="row">
				<div class="col-md-2">
				...
				<div class="col-md-5">
					<input type="text" name="amount" size="20" value="${current.amount}">
				</div>
			</div>
