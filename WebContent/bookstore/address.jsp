		...
		<div class="row list-menu">
			<nav class="navbar navbar-expand-md col-md-12 menu">
				<ul class="navbar-nav ">
					...
					<li class="nav-item"><a class="nav-link" href="${urlListBook}"
						targer="_self"><fmt:message key="home" /></a></li>
					<c:url var="urlContact" value="./bookstore/contact.jsp">

					</c:url>
					<li class="nav-item"><a class="nav-link" href="${urlContact}"
				...
				<form class="form-inline ">
					...
					<a class="btn btn-success btn-sm ml-3"
						href="${pageContext.request.contextPath}/${url}"><fmt:message
							key="cart" /> <c:url var="urlAcc" value="bookstore/account.jsp">
						</c:url> </a> <a class="account ml-3"
						href="${pageContext.request.contextPath}/${urlAcc}"
						style="color: white;"> ${acc.name} </a>
		...
		<div class="row">
			<div class="col">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><c:url var="url"
								value="ListBookServlet"></c:url> <c:url var="url"
								value="ListBookServlet"></c:url> <a
							href="${pageContext.request.contextPath}/${url}"><fmt:message
									key="home" /></a></li>
						<li class="breadcrumb-item"><a
							href="${pageContext.request.contextPath}/bookstore/address.jsp"><fmt:message
									key="account" /></a></li>
		...
		<div class="row ">
			<div class="col-md-3">
				...
				<ul class=" nav nav-pills flex-column profile-work" role="tablist">
					...
					<li class=" nav-item nav1 "><a class="nav-link " id="info-tab"
						data-toggle="pill"
						href="${pageContext.request.contextPath}/${urlAcc}"><fmt:message
								key="personalInfo" /></a></li>
					<c:url var="urlBill" value="bookstore/bill.jsp">
					</c:url>
					...
					<li class="  nav-item nav5"><a class="nav-link  active"
					...
					<li class="  nav-item nav5"><c:url var="url" value="../Logout">
						...
						</c:url> <a href="${url}" class="btn btn-basic btn-block logout"
						style="text-align: left"> <fmt:message key="signout" /></a></li>
				</ul>
			</div>


			<div
				class="col-md-8 col-md-offset-1 border border-success border-right-0 border-top-0 border-bottom-0  ">



				<div id="address" class="tab-pane  in active " role="tabpanel"
					aria-labelledby="address-tab">
					<form method="post"
						action="${pageContext.request.contextPath}/ListBookServlet">
						<div class="row">
							<div class="col-md-12">
								<h4>
						...
						<div class="row">
							...
							<div class="col-md-9">
								<h6 class="address_detail" name="accAddress"
								 style="width: 100%">${acc.address}</h6> 
								 <h6 style="width: 100%">${acc.phone}</h6>
							</div>
						...
						<!--		<div class="row">
							...
							<div class="col-md-12">
								...
								<c:url var="url" value="${pageContext.request.contextPath}/ListBookServlet">
									<c:param name="action" value="EditAddress"></c:param>
									<c:param name="accId" value="${acc.id}"></c:param>
								</c:url>
								<br> <br> 
									<input type="submit" value=<fmt:message key="editBook" />
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9 col-lg-9 col-xl-8">
					...
					<br> <i class="mb-0">At BookStore you will find the best
						books to read from our bookstore. We are proud to continue to
						offer you competitively low prices since our opening. We are
						affordable and quality collection series.</i>
				</div>
