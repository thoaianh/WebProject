				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a
							href="${pageContext.request.contextPath}/state.jsp"><fmt:message
									key="state" /> </a></li>
		...
		<div class="row ">
			<div class="col-md-3">
				...
				<ul class=" nav nav-pills flex-column profile-work" role="tablist">
					...
					<li class="  nav-item nav4"><a class="nav-link  active"
						id="state-tab" data-toggle="pill"
			...
			<div
				...
				<div id="state" class="tab-pane" role="tabpanel"
					...
					<c:forEach items="${listBill}" var="bill">
						...
						<div class="row">
							<div class="col-md-2">
								<h4 class="id_prod">${bill.bookId}</h4>
							</div>

							<!--	<div class="col-md-4">
								<h4 class="name_product">${item.book.title}</h4>
							</div>


							<div class="col-md-6">
								<h4 class="amount"><fmt:message key="amountInCart" />: ${item.quantity}</h4>
								<h4 class="price" style="margin-top: 15px;"><fmt:message key="totalCost" />:
									${cart.total }</h4>
							</div>  -->
						...
						<div class="row">
							<div class="col-md-12">
								<p class="status_prod_title">
									<fmt:message key="deliver" />
								</p>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<p class="status_prod_title">
									<i><fmt:message key="dayReceive" />: ${receiveDay}</i>
								</p>
							</div>
