				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a
							href="${pageContext.request.contextPath}/bookstore/bill.jsp"><fmt:message
		...
		<div class="row ">
			...
			<div class="col-md-3">
				...
				<ul class=" nav nav-pills flex-column profile-work" role="tablist">
					...
					<li class=" nav-item nav2 "><a class="nav-link  active"
						id="bills-tab" data-toggle="pill"
					...
					<li class="  nav-item nav4"><a class="nav-link" id="state-tab"
						...
						href="${pageContext.request.contextPath}/${urlState}"><fmt:message
								key="billDetail" /></a></li>
					<c:url var="urlAddr" value="bookstore/address.jsp"><c:param name="accId" value="${acc.id}" /></c:url>
			...
			<div
				...
				<c:forEach items="${listBill}" var="bill">
					<div id="bill" class="tab-pane" role="tabpanel"
						aria-labelledby="bills-tab">

						<div class="row">
							<div class="col-md-8">
								<h5 class="id_product">${bill.bookId}</h5>
									<h5 class="name_product">${bill.bookTitle}</h5>
							</div>
